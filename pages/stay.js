            ...
            <div className={styles.eventsWrapper}>
                <div id="stay" className={styles.paddingTopStyles}>
                    ...
                    <div className={styles.stayContainer}>
                        ...
                        <p className={styles.introText}>There are tons of great hotels in Sydney, both in the Central Business District (CBD) and by the beaches. Our wedding events are spread across the city, so feel free to stay where ever you want since it's so easy to get around. Here are just a few that we reccomend!</p>
                        <br></br>
                        <ul className={styles.list}> {/* Use the list style from the Events page */}
                            ...
                            <li className={styles.hotelItem}>
                                ...
                                <div>
                                    ...
                                    <br />
                                    Address: 161 Sussex Street, Sydney, New South Wales 2000 Australia
                        ...
                        <p className={styles.introText}>
                            Additionally, our wedding venue has generiously provided a <strong>15% discount</strong> off a select group of hotels, including:
                            <ul style={{ listStyleType: "disc" }}>
                                <li style={{ marginLeft: "20px" }}><a href="https://abyadina.com/luxury-hotels/sydney/" target="_blank" rel="noopener noreferrer">A by Adina Sydney</a></li>
                                <li style={{ marginLeft: "20px" }}><a href="https://www.tfehotels.com/en/hotels/adina-apartment-hotels/bondi-beach-sydney/" target="_blank" rel="noopener noreferrer">Adina Apartment Hotel Bondi Beach</a></li>
                                <li style={{ marginLeft: "20px" }}><a href="https://www.adinahotels.com/en/apartments/sydney-darling-harbour/" target="_blank" rel="noopener noreferrer">Adina Apartment Hotel Darling Harbour</a></li>
                                <li style={{ marginLeft: "20px" }}><a href="https://www.adinahotels.com/en/apartments/sydney-surry-hills/" target="_blank" rel="noopener noreferrer">Adina Apartment Hotel Surry Hills</a></li>
                                <li style={{ marginLeft: "20px" }}><a href="https://vibehotels.com/book-accommodation/sydney/hotel-north-sydney/" target="_blank" rel="noopener noreferrer">Vibe Hotel North Sydney</a></li>
                            </ul>
                            <p>
                                See the <a href="/TFE Hotels - Grand Pacific Group 2023.pdf" target="_blank" rel="noopener noreferrer">attached flyer</a> for additional information and QR code.
                            </p>
                            <br />
                        </p>
                        <p className={styles.introText}>
                        ...
                        <p className={styles.introText}>AirBnb is popular in Australia and a great option if you are planning to stay with a large group or as a family! Here are a few options for inspiration, but we recommend searching through the site directly for the best availability.</p>
                        <br></br>
                        ...
                        <p className={styles.introText}>While our wedding venue is located in Mossman, there's no need to limit your accommodation search to the immediate vicinity. Sydney has excellent transportation options and you can easily explore and stay in a wider range of locations. Here are a few areas we recommend:</p>
                        <br></br>
